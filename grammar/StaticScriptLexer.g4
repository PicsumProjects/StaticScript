...
// 二元操作符
Plus:                           '+';    // (integer|number|string)->(integer|number|string): Plus既是一元操作符也是二元操作符
...
ArithmeticShiftRight:           '>>';   // integer->integer
LogicalShiftRight:              '>>>';  // integer->integer
LessThan:                       '<';    // number->boolean
GreaterThan:                    '>';    // number->boolean
LessThanEquals:                 '<=';   // number->boolean
GreaterThanEquals:              '>=';   // number->boolean
Equals:                         '==';   // (integer|number|boolean|string)->boolean
NotEquals:                      '!=';   // (integer|number|boolean|string)->boolean
And:                            '&&';   // boolean->boolean
Or:                             '||';   // boolean->boolean
Assign:                         '=';    // (integer|number|boolean|string)->(integer|number|boolean|string)
...
BitAndAssign:                   '&=';   // integer->integer
BitXorAssign:                   '^=';   // integer->integer
BitOrAssign:                    '|=';   // integer->integer
ShiftLeftAssign:                '<<=';  // integer->integer
ArithmeticShiftRightAssign:     '>>=';  // integer->integer
LogicalShiftRightAssign:        '>>>='; // integer->integer
